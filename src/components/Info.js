        ...
        <Provider template={AlertTemplate} {...options}>
            <Fragment>
                <div className="info--container">
                    <img className="info--img" src="../image/info--image.jpg" />
                    <h1 className="info--name">Vince Vice Tamayo</h1>
                    <h3 className="info--position">Frontend Developer</h3>
                    <a href="https://vct-porfolio.netlify.app/" className="info--portfolio" target="_blank">https://vct-porfolio.netlify.app/</a>
                    <div className="info--btnGroup">
                        <CopyToClipboard text="vincevicetamayo@gmail.com">
                            <button className="info--btnEmail" onClick={() => {alert("Email copied to clipboard");}}>
                                <svg className="btnEmail--svg" width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="info--btnEmailTitle">Email</span>
                            </button>
                        </CopyToClipboard>

                        <a href="https://www.linkedin.com/in/vince-vice-tamayo-a0304a222/" className="href-linkedin" target="_blank">
                            <button className="info--btnLinkedIn">
                                <svg className="btnLinkedIn-svg" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="info--btnLinkedInTitle">LinkedIn</span>
                            </button>
                        </a>
                    </div>
                </div>
